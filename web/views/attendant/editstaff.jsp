							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                                                <div id="ajaxResponse">${returnMessage}</div>
                                                                  ...
                                                                  <a href="${pageContext.request.contextPath}/staff/viewstaff.html" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Staff List</a>
                                                                  </c:if>
                                                                <c:if test="${display}">
                                                                <!-- PAGE CONTENT BEGINS -->
								<div class="row">
								...
								<form class="form-horizontal" role="form" name="editStaff" method="POST" action="editstaff.html"  id="editstaff">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="confirm_password" placeholder="Confirm Password" name="confirm_password" class="col-xs-10 col-sm-5" />
