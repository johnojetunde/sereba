				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Sales Frequency  </li>
						</ul><!-- /.breadcrumb -->
									...
									<div class="col-sm-11">
										<div class="tabbable">
											<ul class="nav nav-tabs" id="myTab">
												<li class="active">
													<a data-toggle="tab" href="#sales_freq">
											...
											<div class="tab-content">
												<div id="sales_freq" class="tab-pane fade in active">
													
								<form  role="form" name=""  id="salesfreqForm" action="#" method="post" onSubmit="submitFormSalesFrequency('salesfreqForm', 'frequencyquery.html');return false;" class="form-horizontal">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="submit" onSubmit="submitFormSalesFrequency('sales_freq', 'frequencyquery.html');return false;">
